...
describe('BST', () => {
  ...
  describe('insert', () => {
    ...
    it('succeeds on multiple nodes', () => {
      const myTree = new BST();
      myTree.insert(10);
      let a = myTree.insert(5);
      let b = myTree.insert(15);
      let c = myTree.insert(0);
      let d = myTree.insert(7);
      let e = myTree.insert(12);
      let f = myTree.insert(18);
