...
const sortMeetingsByDay = (arr) => {
  return arr.sort( (a,b) => {
    ...
    return helper.indexOf(a.dayOfWeek) < helper.indexOf(b.dayOfWeek) ? -1 : 1;
...
const sortSchedule = (arr) => {
  return arr.sort( (a,b) => {
    ...
    // day
    if (helper.indexOf(a.dayOfWeek) < helper.indexOf(b.dayOfWeek)) { return -1};
    if (helper.indexOf(a.dayOfWeek) > helper.indexOf(b.dayOfWeek)) { return 1};
