...
// re-defined removeOne, in order to accomodate the default parameters accepted by the callback function
// they are value, index, and array, and as far as I know can't be changed to only value and array.

const removeOne = (value, idx, arr) => {
  if (value % 3 === 2){
    arr.pop();
  }
}
