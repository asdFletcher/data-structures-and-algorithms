...
describe('splay tree', () => {
  ...
  describe('insertWithoutSplay', () => {
    ...
    it('works with 0 node tree', ()=> {
      const myTree = new SplayTree();
      let result = myTree.insertWithoutSplay(1);
    ...
    it('works with 1 node tree, left leaf', ()=> {
      ...
      let result = myTree.insertWithoutSplay(0);
    ...
    it('works with 1 node tree, right leaf', ()=> {
      const myTree = new SplayTree();
      myTree.insertWithoutSplay(1);
      let result = myTree.insertWithoutSplay(2);
    ...
    it('works with multiple nodes', () => {
      ...
      //   0   7  12  18
      const myTree = new SplayTree();
      let a = myTree.insertWithoutSplay(10);
      let b = myTree.insertWithoutSplay(5);
      let c = myTree.insertWithoutSplay(15);
      let d = myTree.insertWithoutSplay(0);
      let e = myTree.insertWithoutSplay(7);
      let f = myTree.insertWithoutSplay(12);
      let g = myTree.insertWithoutSplay(18);
  ...
  describe('remove', () => {
    it('fails given no parameters', () => {
      let myTree = new SplayTree();

      myTree.insertWithoutSplay(5);

      let result = myTree.remove();
      expect(result).toBeUndefined();
    ...
    it('succeeds on remove root of 2 node tree, leaf to left', () => {
      let myTree = new SplayTree();
      let a = myTree.insertWithoutSplay(2);
      let b = myTree.insertWithoutSplay(1);
    ...
    it('succeeds on remove root of 2 node tree, leaf to right', () => {
      let myTree = new SplayTree();
      let a = myTree.insertWithoutSplay(2);
      let b = myTree.insertWithoutSplay(3);
    ...
    it('succeeds on remove root of 3 node tree, balanced, random left', () => {
      ...
      let a = myTree.insertWithoutSplay(2);
      let b = myTree.insertWithoutSplay(1);
      let c = myTree.insertWithoutSplay(3);
    ...
    it('succeeds on remove leaf, a 2 deep single child to the left', () => {
      let myTree = new SplayTree();
      let a = myTree.insertWithoutSplay(5);
      let b = myTree.insertWithoutSplay(3);
      let c = myTree.insertWithoutSplay(7);
      let d = myTree.insertWithoutSplay(2);
    ...
    it('succeeds on remove leaf, a 2 deep single child to the right', () => {
      ...
      let b = myTree.insertWithoutSplay(3);
      let c = myTree.insertWithoutSplay(7);
      let d = myTree.insertWithoutSplay(4);
      //       5            3       
      //     3   7   =>       5      
      //      4                 7    
    ...
    it('succeeds on remove node with 2 children, random left, left child has 2 leaf children', () => {
      ...
      let removedValue = 5;
      let result = myTree.remove(removedValue);
      let expected = new Node(removedValue);
